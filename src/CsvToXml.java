...
public class CsvToXml
{
    ...
    public static void main(String[] args) throws ParserConfigurationException
    {
        ...
        // rSe rellena ahora con los países
        ...
        var gdb = new GeneradorXML(ficheroXMLDestino, doc);
        ...
        paises.forEach((p, valor) ->
        {
            ...
            var listaAerolineasPorPaisActual = aerolineasPorPais.get(p);

            // Se recorren las aerolíneas introduciendo cada una como objeto XML
            for (var aerolinea : listaAerolineasPorPaisActual)
            {
        ...
        else System.out.println("Hay algún problema. Fichero no válido!");
    }
}
